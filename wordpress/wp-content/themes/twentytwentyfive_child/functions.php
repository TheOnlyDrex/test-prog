...
add_shortcode('wrap_code', 'wrap_in_code'); //nome shortcode, nome funzione che vogliamo chiamare
...
/*** SVG SUPPORT ***/
    ...
    if (!function_exists('zav_add_svg_mime_type')) :
         ...
         */
        function zav_add_svg_mime_type($mimes) { //prende in ingresso un array di elementi e gli aggancia un elemento
...
if (!function_exists('zav_register_post_types_and_taxonomies')) :
    ...
    add_action( 'init', 'zav_register_post_types_and_taxonomies' );//devono essere agganciate subito, quindi su init
...
if (!function_exists('zav_register_block_styles')) :
    ...
    function zav_register_block_styles() {
        ...
        */
        ...
        wp_enqueue_block_style( 'core/group', array(//non funziona
                'handle'=> 'custom-tab',
                'src'   => get_theme_file_uri( 'custom-tab.css' ),
                'deps'  => array(),
                'ver'   => null,
                'media' => 'all'
            ) );
...
include('blocks/cer-social-phone/index.php');